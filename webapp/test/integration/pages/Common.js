sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/baba/ZDSD_CHANGESO1/app", ".html");
		...
		return Opa5.extend("com.baba.ZDSD_CHANGESO1.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/baba/ZDSD_CHANGESO1/localService/mockserver"], function (mockserver) {
